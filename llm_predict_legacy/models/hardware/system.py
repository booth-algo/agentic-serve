from llm_predict_legacy.models.hardware.device import Device, device_dict
from llm_predict_legacy.models.hardware.interconnect import InterConnectModule, interconnect_module_dict
