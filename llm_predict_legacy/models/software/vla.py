...
from llm_predict_legacy.models.software.communication_primitives import AllReduceMultiPCB, P2P as P2PPrimitive
...
class OpenVLAForActionPredictionPP(Operator):
    ...
    def __init__(
        ...
        if data_type is None:
            from llm_predict_legacy.models.software.utils import data_type_dict
