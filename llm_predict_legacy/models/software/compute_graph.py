...
from llm_predict_legacy.models.hardware.interconnect import InterConnectModule, LinkModule, TopologyType
from llm_predict_legacy.models.software.utils import DataType, data_type_dict
