...
API
---
    from llm_predict_legacy.training.per_kernel import splits
...
CLI
---
    python -m llm_predict_legacy.training.per_kernel.splits \\
        --per-family-dir llm_predict_legacy/training/per_kernel/data/per_family \\
        --report llm_predict_legacy/training/per_kernel/reports/splits_report.md
"""
