...
and writes one pkl per GPU at:
    ...
    llm_predict_legacy/profiling/data/{gpu}/trained/per_op/perop_v5_shape.pkl

The runtime loader at `llm_predict_legacy/predictors/per_op/predictor.py`
...
def main() -> None:
    ...
    llm_predict_legacy_dir = pkg_dir.parents[1]
