...
CLI
---
    python -m llm_predict_legacy.training.per_op.validate \
...
from llm_predict_legacy.predictors.per_op.predictor import PerOpPredictor
from llm_predict_legacy.training.per_kernel import model_specs
from llm_predict_legacy.training.per_kernel.validate import (
