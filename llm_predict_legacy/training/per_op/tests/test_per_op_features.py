...
3. `OP_MAP` is consistent with `llm_predict_legacy/predictors/per_op/features.py`
...
Invoke:
    pytest llm_predict_legacy/training/per_op/tests/
"""
...
def test_op_map_has_expected_module_names():
    ...
    layer walker (llm_predict_legacy/models/software/transformer.py) emits and
...
def test_op_map_matches_runtime_features_module_keys():
    ...
    from llm_predict_legacy.predictors.per_op import features as runtime_features
