...
Thin wrapper over `llm_predict_legacy.training.per_kernel.splits`: the split
...
See `llm_predict_legacy/training/per_kernel/splits.py` for the canonical
docstring, invariants, and CLI.
"""
from __future__ import annotations

from llm_predict_legacy.training.per_kernel.splits import (  # noqa: F401
    MIN_TRAIN_ROWS,
    heldout_split,
