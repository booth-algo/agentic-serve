...
Cho et al.'s LLMServingSim~v2~\citep{llmservingsim} achieves 0.97--1.54\% error with runtime-loop simulation and supports MoE but uses lookup tables rather than generalizable ML predictors.
