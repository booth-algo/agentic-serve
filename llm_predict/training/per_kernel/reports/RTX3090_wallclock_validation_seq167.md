# RTX3090 — Wall-clock TTFT Validation (vs inference-benchmark data.json)
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| Llama-8B | supported | vllm | fixed-seq128 | 167 | 1 | 58.77 | 59.66 | 1.49% | 55.06 | 7.7% | 19.68 |
| **supported MAPE** (1 rows) | | | | | | | | **1.49%** | | | |

**Mean overhead across 1 supported rows with ncu data:** 7.7%
