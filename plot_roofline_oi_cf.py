...
# ── workload configs ─────────────────────────────────────────────────
SINGLETURN = [
    dict(key="cl", label="chat-long",   profile="chat-long",   color="#D55E00", marker="o"),
    dict(key="cm", label="chat-medium", profile="chat-medium", color="#CC79A7", marker="s"),
    dict(key="cs", label="chat-short",  profile="chat-short",  color="#0072B2", marker="^"),
]
MULTITURN = [
