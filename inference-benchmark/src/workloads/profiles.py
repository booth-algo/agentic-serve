...
PROFILES: dict[str, WorkloadProfile] = {
    ...
    "swebench-multiturn-synth": WorkloadProfile(
        ...
        osl_tokens=2000,
        isl_stddev=0.0,
        description="APC-aware synthetic SWE-bench agent sessions sampled from empirical turn/input/output traces",
        dataset="distributional-multi-turn",
        file_path="data/distributions/swebench_multiturn.json",
        system_prompt="",
        mode="multi-turn",
    ...
    "terminalbench-multiturn-synth": WorkloadProfile(
        ...
        osl_tokens=2000,
        isl_stddev=0.0,
        description="APC-aware synthetic TerminalBench CLI-agent sessions sampled from empirical turn/input/output traces",
        dataset="distributional-multi-turn",
        file_path="data/distributions/terminalbench_multiturn.json",
        system_prompt="",
        mode="multi-turn",
