...
PROFILES: dict[str, WorkloadProfile] = {
    ...
    # MSE-validation variant: same ISL filter as legacy swebench-multiturn-short.
    # Uses a filtered distribution so both profiles sample from the same session
    # population (max turn ISL <= 32768). Active=False — manual use only.
    "swebench-multiturn-mse": WorkloadProfile(
        name="swebench-multiturn-mse",
        isl_tokens=32768,
        osl_tokens=2000,
        isl_stddev=0.0,
        description="MSE-validation: filtered swebench distribution matched to legacy ISL=32768",
        dataset="distributional-multi-turn",
    ...
    "terminalbench-multiturn-mse": WorkloadProfile(
        ...
        osl_tokens=1000,
        isl_stddev=0.0,
        description="MSE-validation: filtered terminalbench distribution matched to legacy ISL=32768",
        dataset="distributional-multi-turn",
    ...
    "osworld-multiturn-mse": WorkloadProfile(
        ...
        osl_tokens=500,
        isl_stddev=0.0,
        description="MSE-validation: filtered osworld distribution matched to legacy ISL=32768",
        dataset="distributional-multi-turn",
