...
class DistributionalSampler:
    ...
    def sample_session_with_turn_count(self, *, session_id: int, turn_count: int) -> SyntheticSession:
        ...
        for turn_index in range(turn_count):
            ...
            if self.max_context_tokens is not None and desired_total_context > self.max_context_tokens:
                remaining = self.max_context_tokens - context_before_user
                if remaining <= 0:
                    break
            ...
            previous_output_tokens = sample.output_tokens
