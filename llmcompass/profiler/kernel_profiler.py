...
def main() -> None:
    ...
    Command-line entry point.  Example usage:
        ...
        python -m llmcompass.profiler.kernel_profiler --device cuda:0

        # Quick smoke-test with a reduced grid (useful in CI or on smaller GPUs)
        python -m llmcompass.profiler.kernel_profiler --quick --device cuda:0

        # Custom output directory
        python -m llmcompass.profiler.kernel_profiler --output-dir profiler/profiles/A100
    """
